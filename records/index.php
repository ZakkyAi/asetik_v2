            ...
            <tbody>
                ...
                foreach ($records as $row): ?>
                    <tr>
                        ...
                        <td>
                            <?= $row['user_photo'] ? "<img src='../upload_image/uploads/" . $row['user_photo'] . "' alt='User Photo' width='100'>" : "No Photo" ?>
                        </td>
                        <td><?= $row['product_name'] ?></td>
                        <td>
                            <?= $row['product_photo'] ? "<img src='../upload_image/uploads_products/" . $row['product_photo'] . "' alt='Product Photo' width='100'>" : "No Photo" ?>
                        </td>
