...
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <?php if ($user['photo']): ?>
                    <img src="<?= url('public/uploads/' . htmlspecialchars($user['photo'])) ?>" alt="User Photo" style="width: 120px;">
                <?php else: ?>
                    No Photo
                <?php endif; ?>
            </td>
        ...
        <tr>
            ...
            <td>
                <?php if ($record['product_photo']): ?>
                    <img src="<?= url('public/uploads/' . htmlspecialchars($record['product_photo'])) ?>" alt="Product Photo" style="max-width: 120px;">
                <?php else: ?>
                    No Photo
                <?php endif; ?>
            </td>
